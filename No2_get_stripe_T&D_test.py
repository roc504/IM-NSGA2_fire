...
data='9'
times='1'
cal_line_stime='2023-04-09 03:21:00'#计算星下点直线的开始时间点,根据xxx_undersatellet_line.xlsx文件里的时间填，最好两个临近时间，保证开始点与结束点构成的直线受地球曲率影像最小#gf22023-01-19 02:30:00\sentinel2023-01-19 03:09:10\fy3a2023-01-19 06:41:00\jl2023-01-19 04:11:00\gj2b2023-01-18 22:39:00\gf12023-01-20 02:56:00
cal_line_etime='2023-04-09 03:21:30'#计算星下点直线的结束时间点#gf22023-01-19 02:35:00\sentinel2023-01-19 03:09:20\fy3a2023-01-19 06:42:00jl2023-01-19 04:12:00\gj2b2023-01-18 22:40:00\gf12023-01-20 02:57:00
start_time = time.time()
pass_time = '2023-04-09 03:21:00'#gaofen2023-01-19 02:30:00、sentinel2023-01-19 03:09:10、fy3a2023-01-19 06:41:00、jl2023-01-19 04:11:16#前一时刻时间
h , w = 645000 ,10.97#卫星高度，视场角 °2w=arctan(幅宽/2h)*(180 / np.pi)
P = 35#/(180 / np.pi)  # 高分2 的侧摆角,度换算成弧度'''
orbit_orientation = 'right'#'right' # 卫星轨道偏向，left是指'\'轨道，向左倾斜，right是‘/’轨道，向右倾斜
open_time='2023,4,9,3,20,57'#选择开关机时间#gaofen2:2023,01,19,2,33,10
close_time='2023,4,9,3,22,17'#选择开关机时间
# #卫星幅宽边界左右轻微移动微小距离，也就是一个格网的对角线长度
# swing_orno=1#swing_orno为1说明有侧摆角，0为无侧摆角
# grid_wid=5000#格网长度5000米
# s=math.sqrt((grid_wid*0.0000089932202929999989)**2+(grid_wid*0.0000089932202929999989)**2)
#卫星幅宽信息
# sat_strp_wid=12000#sentinel2b卫星条带幅宽
    ...
    if orbit_orientation == 'left':
        ...
        for _ in grid_U_left_num:
            ...
            for j in range(len(grid_all)):
                grid_t = grid_all[j]
                # 作过t格网右上点直线平行于星下点的直线，作过u格网左下点直线平行于星下点的直线
        ...
        for i in range(len(grid_all)):
            ...
            satestripelengline = get_satestripe_lengline(undersate1[0], undersate1[1],
                                                         undersate2[0], undersate2[1],
                                                         grid_u[1][0],
                                                         grid_u[1][1])  # grid_u[0][0]代表grid_u格网0号点（左下点）的x
        ...
        for _ in grid_U_right_num:
            ...
            for j in range(len(grid_all)):
                grid_t = grid_all[j]
                # 作过t格网左上点直线平行于星下点的直线，作过u格网右下点直线平行于星下点的直线
                satestripelengline_u = get_satestripe_lengline(undersate1[0], undersate1[1],
                                                               undersate2[0], undersate2[1],
                                                               grid_u[3][0],
                                                               grid_u[3][1])
